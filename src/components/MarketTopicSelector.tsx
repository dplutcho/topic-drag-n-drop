        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1">
            <DropZone 
              ...
              tooltipText="Topics that the prospects are also interested in but does NOT define your core solution or your core audience. These topics are always within the context of the core topics. e.g AI as a supportive topic will only include intent that is about Fintech AI."
              onChildSelectionChange={(topicId, childId, selected) => 
